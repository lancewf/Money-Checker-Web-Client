...
public class AddEntryControl extends FormPanel
{
   // --------------------------------------------------------------------------
   // Private Data
   // --------------------------------------------------------------------------
   ...
   public AddEntryControl(BillTypeManager billTypeManager, 
                          ServiceLocations serviceLocations, 
                          List<String> stores)
   {
      setHeading("Add Entry");
      setPadding(0);
      setFrame(false);
                           ...
                           ServiceLocations serviceLocations)
   {
      ...
      add(dateField, formData);
      add(billTypeField, formData);
      add(notesField, formData);
      add(matchingField);
   ...
   private void toggleSplit()
   {
      ...
      if(isSplit)
      {
         ...
         billTypeComboBox.setVisible(false);
      ...
      else
      {
         ...
         billTypeComboBox.setVisible(true);
   ...
   private void sendPurchase()
   {
      ...
      PurchaseSender purchaseSender = new PurchaseSender(cost, store,
         note, billType, date, AddEntryControl.this.serviceLocations);
